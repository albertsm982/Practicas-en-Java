...
public class GestorGruposTest {
	...
	class ComprobandoEstadoInicial {
		...
		/**
		 * Comprueba que no hay conflictos colocando una pieza en celda al inicio con un
		 * tablero vacío.
		 * 
		 * @param fila    fila
		...
		void probarQueNoHayConflictosEnUnTableroVacio(int fila, int columna) throws CoordenadasIncorrectasException {
	...
	class ComprobancoCorreccionDeGruposCreados {
		...
		void probarAsignacionGrupos(int fila, int columna) throws CoordenadasIncorrectasException {

				Celda celda = tablero.obtenerCelda(fila, columna);
				List<Grupo> gruposRelacionados = gestorGrupos.obtenerGruposConteniendoCelda(celda);
				assertThat("La celda no tiene asignado un número de grupos correcto.", gruposRelacionados.size(),
						is(3));
		...
		void probarAsignacionGruposHorizontales(int fila, int columna, int[][] coordenadasDeGrupo)
				...
				assertThat("La celda " + celda.toString() + " no tiene asignado el grupo horizonal.",
						gruposRelacionados, hasItems(grupo));
		...
		void probarAsignacionGruposVerticales(int fila, int columna, int[][] coordenadasDeGrupo)
				...
				Grupo grupo = generarGrupo(coordenadasDeGrupo);
				List<Grupo> gruposRelacionados = gestorGrupos.obtenerGruposConteniendoCelda(celda);
				assertThat("La celda " + celda.toString() + " no tiene asignado el grupo vertical.", gruposRelacionados,
						hasItems(grupo));
		...
		void probarAsignacionGruposCuadrados(int fila, int columna, int[][] coordenadasDeGrupo)
				...
				Grupo grupo = generarGrupo(coordenadasDeGrupo);
				List<Grupo> gruposRelacionados = gestorGrupos.obtenerGruposConteniendoCelda(celda);
				assertThat(gruposRelacionados, hasItems(grupo));
		 ...
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		 */
		private Grupo generarGrupo(int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {

				List<Celda> celdas = new ArrayList<>();
				for (int i = 0; i < 4; i++) {
					int fila = coordenadasDeGrupo[i][0];
					int columna = coordenadasDeGrupo[i][1];
					celdas.add(tablero.obtenerCelda(fila, columna));
				}
	...
	class CreandoGruposGanadores {
		...
		/**
		 * Comprueba que al colocar cuatro piezas diferentes del mismo color en el grupo
		 * horizontal se tiene un ganador.
		 * 
		...
		public void comprobarHayGrupoGanadorEnHorizontalesConPiezasDeIgualesColores(int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {
			colocarCuatroPiezasDiferentesDelMismoColor(coordenadasDeGrupo);
		}

		/**
		 * Comprueba que al colocar cuatro piezas diferentes de diferentes colores en el
		 * grupo horizontal se tiene un ganador.
		 * 
		 * @param coordenadasDeGrupo coordenadas de grupo horizontal
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		 */
		...
		public void comprobarHayGrupoGanadorEnHorizontalesConPiezasDeDiferentesColores(int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {
			colocarCuatroPiezasDiferentesVariandoColores(coordenadasDeGrupo);
		}

		/**
		 * Comprueba que al colocar cuatro piezas diferentes del mismo color en el grupo
		 * vertical se tiene un ganador.
		 * 
		...
		public void comprobarHayGrupoGanadorEnVerticalesConPiezasDeIgualesColores(int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {
			colocarCuatroPiezasDiferentesDelMismoColor(coordenadasDeGrupo);
		}

		/**
		 * Comprueba que al colocar cuatro piezas diferentes de diferentes colores en el
		 * grupo vertical se tiene un ganador.
		 * 
		 * @param coordenadasDeGrupo coordenadas de grupo vertical
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		 */
		...
		public void comprobarHayGrupoGanadorEnVerticalesConPiezasDeDiferentesColores(int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {
			colocarCuatroPiezasDiferentesVariandoColores(coordenadasDeGrupo);
		}

		/**
		 * Comprueba que al colocar cuatro piezas diferentes del mismo color en el grupo
		 * cuadrado se tiene un ganador.
		 * 
		...
		public void comprobarHayGrupoGanadorEnCuadradosConPiezasDeIgualesColores(int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {
			colocarCuatroPiezasDiferentesDelMismoColor(coordenadasDeGrupo);
		}

		/**
		 * Comprueba que al colocar cuatro piezas diferentes de diferentes colores en el
		 * grupo cuadrado se tiene un ganador.
		 * 
		 * @param coordenadasDeGrupo coordenadas de grupo cuadrado
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		 */
		...
		public void comprobarHayGrupoGanadorEnCuadradosConPiezasDeDiferentesColores(int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {
			colocarCuatroPiezasDiferentesVariandoColores(coordenadasDeGrupo);
		}

		/**
		 * Coloca piezas de diferentes figuras y del mismo color en el grupo comprobando
		 * que hay ganador.
		 * 
		 * @param coordenadasDeGrupo coordenadas de celdas en el grupo
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		 */
		private void colocarCuatroPiezasDiferentesVariandoColores(int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {
				tablero.colocar(coordenadasDeGrupo[0][0], coordenadasDeGrupo[0][1],
						new Pieza(Figura.CILINDRO, Color.BLANCO));
				tablero.colocar(coordenadasDeGrupo[1][0], coordenadasDeGrupo[1][1],
						new Pieza(Figura.CONO, Color.NEGRO));
				tablero.colocar(coordenadasDeGrupo[2][0], coordenadasDeGrupo[2][1],
						new Pieza(Figura.CUBO, Color.BLANCO));
				tablero.colocar(coordenadasDeGrupo[3][0], coordenadasDeGrupo[3][1],
						new Pieza(Figura.ESFERA, Color.NEGRO));
				assertThat("Debería haber grupo completo.", gestorGrupos.hayGrupoGanador(), is(true));
		}

		/**
		 * Coloca piezas de diferentes figuras y de distintos colores en el grupo
		 * comprobando que hay ganador.
		 * 
		 * @param coordenadasDeGrupo coordenadas de celdas en el grupo
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		 */
		private void colocarCuatroPiezasDiferentesDelMismoColor(int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {
				tablero.colocar(coordenadasDeGrupo[0][0], coordenadasDeGrupo[0][1],
						new Pieza(Figura.CILINDRO, Color.BLANCO));
				tablero.colocar(coordenadasDeGrupo[1][0], coordenadasDeGrupo[1][1],
	...
	class ComprobarCasosSinGrupoGanadorConMenosDeCuatroPiezas {
		...
		/**
		 * Comprueba que no hay ganador con cuatro piezas diferentes en figura y mismo
		 * color en las esquinas.
		 * 
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		 * 
		 */
		...
		void comprobarConPiezasDelMismoColorEnEsquinas() throws CoordenadasIncorrectasException {
				...
				assertThat(
						"No debería haber grupo ganador con cuatro piezas diferentes del mismo color en las esquinas.",
						gestorGrupos.hayGrupoGanador(), is(false));

		}

		/**
		 * Comprueba que no hay ganador con cuatro piezas diferentes en figura y
		 * diferente color en las esquinas.
		 * 
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		 * 
		 */
		...
		void comprobarConPiezasDeDiferentesColoresEnEsquinas() throws CoordenadasIncorrectasException {
				tablero.colocar(0, 0, new Pieza(Figura.ESFERA, Color.BLANCO));
				tablero.colocar(0, 3, new Pieza(Figura.CUBO, Color.NEGRO));
				tablero.colocar(3, 0, new Pieza(Figura.CONO, Color.BLANCO));
				tablero.colocar(3, 3, new Pieza(Figura.CILINDRO, Color.NEGRO));
				assertThat(
						"No debería haber grupo ganador con cuatro piezas diferentes variando colores en las esquinas.",
						gestorGrupos.hayGrupoGanador(), is(false));

		}

		/**
		 * Comprueba que no hay ganador con tres piezas diferentes en figura y mismo
		 * color en las esquinas.
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		 * 
		 */
		...
		void comprobarConPiezasDelMismoColorCon2PorVerticalYHorizontal() throws CoordenadasIncorrectasException {
				...
				tablero.colocar(3, 3, new Pieza(Figura.CILINDRO, Color.NEGRO));
				assertThat("No debería haber grupo ganador con 3 piezas diferentes del mismo color en dos esquinas.",
						gestorGrupos.hayGrupoGanador(), is(false));
		...
		void comprobarConPiezasDelMismoColorCon3PorHorizontal() throws CoordenadasIncorrectasException {
				...
				tablero.colocar(3, 3, new Pieza(Figura.CILINDRO, Color.NEGRO));
				assertThat(
						"No debería haber grupo ganador con 3 piezas diferentes del mismo color en dos horizontales.",
						gestorGrupos.hayGrupoGanador(), is(false));
		...
		void comprobarConPiezasDelMismoColorCon3PorVertical() throws CoordenadasIncorrectasException {
				...
				tablero.colocar(3, 3, new Pieza(Figura.CILINDRO, Color.NEGRO));
				assertThat("No debería haber grupo ganador con 3 piezas diferentes del mismo color en dos verticales.",
						gestorGrupos.hayGrupoGanador(), is(false));

		}

		/**
		 * Comprueba que no hay ganador con tres piezas diferentes en figura y diferente
		 * color en horizontal.
		 * 
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		 * 
		...
		void comprobarConPiezasDeDiferenteColorCon3PorHorizontal() throws CoordenadasIncorrectasException {
				...
				tablero.colocar(3, 3, new Pieza(Figura.CILINDRO, Color.NEGRO));
				assertThat(
						"No debería haber grupo ganador con 3 piezas diferentes de diferentes colores en dos horizontales.",
						gestorGrupos.hayGrupoGanador(), is(false));
		 ...
		 */
		@Test
		@DisplayName("Comprobar con piezas de diferente figura y color con tres en vertical.")
		void comprobarConPiezasDeDiferenteColorCon3PorVertical() throws CoordenadasIncorrectasException {
				tablero.colocar(0, 0, new Pieza(Figura.ESFERA, Color.BLANCO));
				...
				tablero.colocar(3, 3, new Pieza(Figura.CILINDRO, Color.NEGRO));
				assertThat(
						"No debería haber grupo ganador con 3 piezas diferentes de diferentes colores en dos verticales.",
						gestorGrupos.hayGrupoGanador(), is(false));
	...
	class CreandoFalsosGruposGanadoresConCuatroPiezasPeroAlgunaRepetida {
		...
		/**
		 * Comprueba que no hay ganador con piezas del mismo color en horizontal
		 * repitiendo alguna figura.
		 * 
		...
		public void comprobarNoHayGrupoGanadorEnHorizontalesConPiezasRepetidasDeIgualesColores(
				int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {
			colocarCuatroPiezasPeroAlgunaRepetidaDelMismoColor(coordenadasDeGrupo);
		}

		/**
		 * Comprueba que no hay ganador con piezas de diferente color en horizontal
		 * repitiendo alguna figura.
		 * 
		 * @param coordenadasDeGrupo coordenadas de grupo
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		...
		public void comprobarNoHayGrupoGanadorEnHorizontalesConPiezasDeDiferentesColores(int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {
			colocarCuatroPiezasPeroAlgunaRepetidaVariandoColores(coordenadasDeGrupo);
		}

		/**
		 * Comprueba que no hay ganador con piezas del mismo color en vertical
		 * repitiendo alguna figura.
		 * 
		 * @param coordenadasDeGrupo coordenadas de grupo
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		...
		public void comprobarNoHayGrupoGanadorEnVerticalesConPiezasDeIgualesColores(int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {
			colocarCuatroPiezasPeroAlgunaRepetidaDelMismoColor(coordenadasDeGrupo);
		}

		/**
		 * Comprueba que no hay ganador con piezas de diferente color en vertical
		 * repitiendo alguna figura.
		 * 
		 * @param coordenadasDeGrupo coordenadas de grupo
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		...
		public void comprobarNoHayGrupoGanadorEnVerticalesConPiezasDeDiferentesColores(int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {
			colocarCuatroPiezasPeroAlgunaRepetidaVariandoColores(coordenadasDeGrupo);
		}

		/**
		 * Comprueba que no hay ganador con piezas del mismo color en cuadrado
		 * repitiendo alguna figura.
		 * 
		 * @param coordenadasDeGrupo coordenadas de grupo
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		...
		public void comprobarNoHayGrupoGanadorEnCuadradosConPiezasDeIgualesColores(int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {
			colocarCuatroPiezasPeroAlgunaRepetidaDelMismoColor(coordenadasDeGrupo);
		}

		/**
		 * Comprueba que no hay ganador con piezas de diferente color en cuadrado
		 * repitiendo alguna figura.
		 * 
		 * @param coordenadasDeGrupo coordenadas de grupo
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		...
		public void comprobarNoHayGrupoGanadorEnCuadradosConPiezasDeDiferentesColores(int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {
			colocarCuatroPiezasPeroAlgunaRepetidaVariandoColores(coordenadasDeGrupo);
		}

		/**
		 * Coloca piezas repitiendo alguna figura y del mismo color en el grupo
		 * comprobando que NO hay ganador.
		 * 
		 * @param coordenadasDeGrupo coordenadas de celdas en el grupo
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		 */
		private void colocarCuatroPiezasPeroAlgunaRepetidaVariandoColores(int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {
				// Repetimos cilindro
				tablero.colocar(coordenadasDeGrupo[0][0], coordenadasDeGrupo[0][1],
						new Pieza(Figura.CILINDRO, Color.BLANCO));
				tablero.colocar(coordenadasDeGrupo[1][0], coordenadasDeGrupo[1][1],
		...
		/**
		 * Coloca piezas repitiendo alguna figura y de diferente color en el grupo
		 * comprobando que NO hay ganador.
		 * 
		 * @param coordenadasDeGrupo coordenadas de celdas en el grupo
		 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
		 */
		private void colocarCuatroPiezasPeroAlgunaRepetidaDelMismoColor(int[][] coordenadasDeGrupo) throws CoordenadasIncorrectasException {
				// Repetimos cilindro
				tablero.colocar(coordenadasDeGrupo[0][0], coordenadasDeGrupo[0][1],
						new Pieza(Figura.CILINDRO, Color.BLANCO));
				tablero.colocar(coordenadasDeGrupo[1][0], coordenadasDeGrupo[1][1],
