...
@Tag("UnitTest")
@DisplayName("Tests sobre Partida (test unitarios simulando con Mockito el resto de clases).")
...
public class PartidaTest {
	...
	void probarQueLaConsultaDeMovimientoLegalNoInvocaAMetodosDeCambioDeEstado(int fila, int columna, Figura figura) throws CoordenadasIncorrectasException {
	...
	void probarQueLaConsultaDePartidaAcabadaNoInvocaAMetodosDeCambioDeEstado() throws CoordenadasIncorrectasException {
	...
	void probarQueLaConsultaDeTurnoActualBloqueadoNoInvocaAMetodosDeCambioDeEstado() throws CoordenadasIncorrectasException {
		...
		List<Pieza> listaPiezasDisponibles = Arrays.asList(piezasDisponibles);
		lenient().when(cajaBlancas.consultarPiezasDisponibles()).thenReturn(listaPiezasDisponibles);
	...
	void probarQueLaConsultaDeGrupoCompletoNoInvocaAMetodosDeCambioDeEstado() throws CoordenadasIncorrectasException {
