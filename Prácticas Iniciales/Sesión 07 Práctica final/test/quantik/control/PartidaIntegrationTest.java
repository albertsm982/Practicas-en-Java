...
public class PartidaIntegrationTest {
	...
	class CambioDeTurno {
		...
		void comprobarCambioTurnoTrasPrimerJugada() throws CoordenadasIncorrectasException {
		...
		void comprobarCambioDeTurnosSucesivosConDosJugadas() throws CoordenadasIncorrectasException {
			partida.colocarPiezaEnTurnoActual(0, 0, Figura.CILINDRO); // turno blanco
			partida.cambiarTurno();
		...
		void comprobarCambioDeTurnosSucesivosConTresJugadas() throws CoordenadasIncorrectasException {
			partida.colocarPiezaEnTurnoActual(0, 0, Figura.CILINDRO); // turno blanco
			partida.cambiarTurno();
			partida.colocarPiezaEnTurnoActual(2, 2, Figura.CILINDRO); // turno negro
			partida.cambiarTurno();
	...
	class JugadasIlegalesColocandoPiezasNoDisponibles {
		...
		void comprobarQueNoDejaColocarUnaTerceraPiezaNoDisponible(Figura figura) throws CoordenadasIncorrectasException {
	...
	class JugadasIlegalesColocandoPiezaEnCuatroEsquinas {
		...
		void comprobarIlegalidadJugadaConFiguraEnEsquinaSuperiorIzquierda(Figura figura) throws CoordenadasIncorrectasException {
			partida.colocarPiezaEnTurnoActual(0, 0, figura);
			partida.cambiarTurno();
		...
		void comprobarIlegalidadJugadaConFiguraEnEsquinaSuperiorDerecha(Figura figura) throws CoordenadasIncorrectasException {
		...
		void comprobarIlegalidadJugadaConFiguraEnEsquinaInferiorIzquierda(Figura figura) throws CoordenadasIncorrectasException {
		...
		void comprobarIlegalidadJugadaConFiguraEnEsquinaInferiorDerecha(Figura figura) throws CoordenadasIncorrectasException {
	...
	class JugadasLegalesColocandoPiezaEnCuatroEsquinas {
		...
		void comprobarLegalidadJugadaConFiguraEnEsquinaSuperiorIzquierda(Figura figura) throws CoordenadasIncorrectasException {
			partida.colocarPiezaEnTurnoActual(0, 0, figura);
			partida.cambiarTurno();
		...
		@ParameterizedTest
		@EnumSource(Figura.class)
		void comprobarLegalidadJugadaConFiguraEnEsquinaSuperiorDerecha(Figura figura) throws CoordenadasIncorrectasException {
			partida.colocarPiezaEnTurnoActual(0, 3, figura);
			partida.cambiarTurno();
		...
		void comprobarLegalidadJugadaConFiguraEnEsquinaInferiorIzquierda(Figura figura) throws CoordenadasIncorrectasException {
			partida.colocarPiezaEnTurnoActual(3, 0, figura);
			partida.cambiarTurno();
		...
		void comprobarLegalidadJugadaConFiguraEnEsquinaInferiorDerecha(Figura figura) throws CoordenadasIncorrectasException {
			partida.colocarPiezaEnTurnoActual(3, 3, figura);
			partida.cambiarTurno();
	 ...
	 */
	@Nested
	@DisplayName("Partidas completas con victoria tras variass jugadas.")
	class PartidasComplejasConVictoria {
		...
		void partidaConVictoriaRapidaEn4Jugadas() throws CoordenadasIncorrectasException {
			// when
			...
			assertAll("estado finalizado corercto con cuatro jugadas",
					...
					() -> assertThat(
							...
							cajaBlancas.consultarPiezasDisponibles(),
					...
					() -> assertThat(
							...
							cajaNegras.consultarPiezasDisponibles(),
		...
		void partidaConVictoriaRapidaEn6Jugadas() throws CoordenadasIncorrectasException {
			// when
			partida.colocarPiezaEnTurnoActual(0, 0, Figura.CILINDRO); // 00CLB
			partida.cambiarTurno();
		...
		void partidaConVictoriaRapidaEn7Jugadas() throws CoordenadasIncorrectasException {
			// when
		...
		void partidaConVictoriaLentaEn10Jugadas() throws CoordenadasIncorrectasException {
			// when
			partida.colocarPiezaEnTurnoActual(0, 0, Figura.CILINDRO); // 00CLB
			partida.cambiarTurno();
			...
			partida.colocarPiezaEnTurnoActual(1, 0, Figura.CONO); // 10CNB
			partida.cambiarTurno();
			partida.colocarPiezaEnTurnoActual(1, 3, Figura.ESFERA); // 13ESN victoria de negras
		...
		void partidaConVictoriaLentaEn12Jugadas() throws CoordenadasIncorrectasException {
			// when
			partida.colocarPiezaEnTurnoActual(0, 0, Figura.CILINDRO); // 00CLB
			partida.cambiarTurno();
		...
		void partidaConVictoriaLentaEn13Jugadas() throws CoordenadasIncorrectasException {
			// when
			partida.colocarPiezaEnTurnoActual(0, 0, Figura.CILINDRO); // 00CLB
			partida.cambiarTurno();
			partida.colocarPiezaEnTurnoActual(1, 2, Figura.CILINDRO); // 12CLN
	...
	class PartidaRellenandoTablero {
		...
		void partidaRellenadoTablero() throws CoordenadasIncorrectasException {
			// when
			partida.colocarPiezaEnTurnoActual(0, 0, Figura.CILINDRO); // 00CLB
			partida.cambiarTurno();
			...
			assertAll("estado finalizado rellenando tablero",
					() -> assertThat("Caja blanca debería estar vacía.",
							cajaBlancas.consultarPiezasDisponibles(), is(empty())),
					() -> assertThat("Caja negra debería estar vacía.",
							cajaNegras.consultarPiezasDisponibles(), is(empty())),
					() -> assertThat(
	...
	class PartidaBloqueandoJugadasDelContrario {
		...
		void partidaBloqueandoABlancas() throws CoordenadasIncorrectasException {
			// when
			partida.colocarPiezaEnTurnoActual(0, 0, Figura.CILINDRO); // 00CLB
			partida.cambiarTurno();
			partida.colocarPiezaEnTurnoActual(3, 3, Figura.CILINDRO); // 33CLN
		...
		void partidaBloqueandoANegras() throws CoordenadasIncorrectasException {
			// when
			partida.colocarPiezaEnTurnoActual(0, 0, Figura.CILINDRO); // 00CLB
			partida.cambiarTurno();
	...
	/**
	 * Consulta de cajas clonadas. 
	 *
	 */
	@Nested
	@DisplayName("Consulta con clonación de cajas")
	class ConsultaConClonacionDeCajas {
		
		/**
		 * Comprueba la clonación de la caja con piezas blancas.
		 */
		@Test
		@DisplayName("Consultar la clonación de caja blanca")
		void comprobarConsultaCajaBlancas() {
			
			Caja cajaBlancas = partida.consultarCajaBlancas();
			assertAll("comprobando consulta y clonación",
					() -> assertThat("El contenido debería ser el mismo tras clonar.", cajaBlancas, is(PartidaIntegrationTest.this.cajaBlancas)),
					() -> assertNotSame("La referencia debería ser distinta tras clonar.", cajaBlancas, PartidaIntegrationTest.this.cajaBlancas)
			);
		}
		
		/**
		 * Comprueba la clonación de la caja con piezas negras.
		 */
		@Test
		@DisplayName("Consultar la clonación de caja negra")
		void comprobarConsultaCajaNegras() {			
			Caja cajaNegras = partida.consultarCajaNegras();
			assertAll("comprobando consulta y clonación",
					() -> assertThat("El contenido debería ser el mismo tras clonar.", cajaNegras, is(PartidaIntegrationTest.this.cajaNegras)),
					() -> assertNotSame("La referencia debería ser distinta tras clonar.", cajaNegras, PartidaIntegrationTest.this.cajaNegras)
			);
		}
	}
}
